...
interface PagePropsAdConfig {
  adConfig: AdConfigAdConfig;
  tourCode: string;
}

interface AdConfigAdConfig {
  config: Config;
  homepage: Aon;
  liveLeaderboard: Aon;
  leaderboard: Aon;
...
const typeMap: any = {
  ...
  AonTypename: ['AdTagConfig'],
  AdTest: ['evolution-web'],
  Pos: ['lb_row', 'lb_row2', 'midcontent', 'midcontent2', 'scorecard_banner', 'tickerspon', 'top'],
  S1: ['pgatour', 'pgatour-yahoo'],
  LeaderboardRoundHeader: ['R-1', 'R2', 'R4'],
  PlayerTypename: ['InformationRow', 'PlayerRowV3'],
  LineColor: ['#0084FF'],
  MovementDirection: ['CONSTANT', 'DOWN', 'UP'],
  PlayerState: ['ACTIVE', 'BETWEEN_ROUNDS', 'COMPLETE', 'WITHDRAWN'],
  RoundStatus: ['', 'R2 Completed', 'R4 Completed'],
  Category: ['competition'],
  CategoryDisplayName: ['Competition'],
  Franchise: ['competition#highlights'],
  FranchiseDisplayName: ['Highlights'],
  TourCode: ['PGATOUR'],
};
